...
open class BarChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    open func drawValue(context: CGContext, value: String, xPos: CGFloat, yPos: CGFloat, font: UIFont, align: NSTextAlignment, color: UIColor, anchor: CGPoint, angleRadians: CGFloat)
    {
        if (angleRadians == 0.0)
        {
