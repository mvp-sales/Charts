...
open class PieChartView: PieRadarChartViewBase
{
    ...
    private var _holeColor: UIColor? = UIColor.white
    
    /// Sets the color the entry labels are drawn with.
    private var _entryLabelColor: UIColor? = UIColor.white
    
    /// Sets the font the entry labels are drawn with.
    private var _entryLabelFont: UIFont? = UIFont(name: "HelveticaNeue", size: 13.0)
    ...
    ///
    /// **default**: `nil`
    open var transparentCircleColor: UIColor?
    {
        get
        {
    ...
    open var entryLabelColor: UIColor?
    {
    ...
    open var entryLabelFont: UIFont?
    {
